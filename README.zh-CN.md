...
在不断壮大的尸潮中坚守阵地。移动、朝鼠标方向自动开火、吸收经验、三选一构筑 build、在战斗间隙用金币补给消耗品，活到 **母巢暴君** 出现并将其击杀。
...
- 🔫 **深度 build 构筑** —— 12 种武器、被动与武器进化，通过升级三选一获取。
- 🛒 **消耗品经济** —— 金币是可持续消耗的资源：购买充能、限时药剂和可叠加护盾。
- 🎨 **多汁的 Canvas 2D 渲染** —— 精灵图、程序化跑步动作、屏幕震动、受击闪烁、粒子、弹道、尸体与血迹。
